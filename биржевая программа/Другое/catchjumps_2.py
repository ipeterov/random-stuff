            ...
            for fallCheckArea in fallCheckAreas:
                for maxFall in maxFalls:
                    ...
                    if myacc.deal_count != 0 and myacc.money > 0:
                        s1 = round(-(1 - myacc.money ** (1 / myacc.deal_count)) * 10000 * 1.25,4), minGrowth, maxFall, growthCheckArea, fallCheckArea,minMedProfit
