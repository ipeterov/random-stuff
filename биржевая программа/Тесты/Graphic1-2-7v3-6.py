import picklezzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz
...
Points_LowerThanMaxToSells = [84,85,86,87,88,89,90,91,92,93,94,95,96]
Ms_LookToSells = [1]
                            ...
                            for Direction in Directions:
                                if Direction == 1:
                                    ...
                                    if my_account.money > -10 and my_account.deal_count > 0:
                                        s1 = round(-(1 - my_account.money ** (1 / my_account.deal_count)) * 10000 * 1.25,4), Area_CheckMax_Value, Area_GiveAFuckAbout, "P", Points_UpperToBuy, Points_LowerThanMaxToSell, Direction, "s", Ms_LookToSell, Points_LowerToSell
