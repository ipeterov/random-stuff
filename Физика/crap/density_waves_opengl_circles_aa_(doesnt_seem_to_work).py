...
def main(quantity, radius, speed, max_x, max_y, min_x=0, min_y=0):
    ...
    fragment = """
        ...
        void main()
        {
            float distance = 0.5 - abs(length(vec2(0.5, 0.5) - gl_PointCoord));
            ...
            gl_FragColor = mix(vec4(255.0, 255.0, 255.0, 1.0), vec4(0.0, 0.0, 0.0, 1.0), t);
        }
    """
    program = gloo.Program(vertex, fragment)
    program['radius'] = radius + 0.5
